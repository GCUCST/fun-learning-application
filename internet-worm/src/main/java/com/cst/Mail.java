...
public class Mail {
    // 发件人地址
    public static String senderAddress = "13144061737@163.com";
    // 收件人地址
    public static String recipientAddress = "13144061737@163.com";
    // 发件人账户名
    ...
    public static MimeMessage getMimeMessage(Session session, String message) throws Exception {
        ...
        // 设置邮件主题
        msg.setSubject("最新交易提醒：" + LocalDateTime.now(), "UTF-8");
        // 设置邮件正文
