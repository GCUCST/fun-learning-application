...
public class UserController {
  ...
  @ApiResponses(
      value = {@ApiResponse(code = 200, message = "succ", response = CommonResponse.class)})
  ...
  //    @ApiImplicitParams({
  //            @ApiImplicitParam(name = "username", value = "用户名称", dataType = "String", paramType
  // = "query")})
  public User getUserInfo(
      @ApiParam(name = "username", value = "用户名11111", required = true, example = "老王")
          String username) {
    User user = new User();
    return user;
  }
