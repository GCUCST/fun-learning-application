...
public class AppSelectDocQuery {
  public static void main(String[] args) throws IOException {
    ...
    // SearchSourceBuilder().query(QueryBuilders.matchQuery("name", "CST"));
    ...
    //        //条件查询
    //        SearchSourceBuilder query = new
    // SearchSourceBuilder().query(QueryBuilders.termQuery("name", "CST1"));
    ...
    FuzzyQueryBuilder fuzzyQueryBuilder =
        QueryBuilders.fuzzyQuery("name", "cst").fuzziness(Fuzziness.AUTO);
